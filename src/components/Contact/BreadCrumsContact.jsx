...
const BreadCrumsContact = () => {
   return (
          <div className="flex flex-wrap justify-center items-center space-x-2 mt-8 mb-8 text-sm text-gray-500 font-medium">
              ...
              <a href="/contact" className='font-bold text-xl mt-1'>Contact Us</a>
              
          </div> 
      );
}

export default BreadCrumsContact