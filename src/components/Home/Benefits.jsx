  ...
  const benefits = [
    {
      ...
      description: "Natural herbal blend for enhanced feminine wellness and care.",
    ...
    },
    {
      ...
      description: "Superior protection ensuring complete leak-proof experience.",
      color: "from-green-400 to-green-600"
 },
    {
      icon: kapok,
          ...
          <div className="text-center mb-16">
            <div className="inline-block">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4">
                Benefits of Using{' '}
                <span className="text-[#93B45D]">Herbal</span>{' '}
                Napkin
              </h1>
              <div className="w-32 h-1.5 bg-gradient-to-r from-[#93B45D] to-[#F18372] mx-auto mb-6 rounded-full"></div>
            </div>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Experience the power of nature with our premium herbal napkins designed for your comfort and wellness
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div className="relative mb-6 flex justify-center">
                  <div className={`w-16 h-16 bg-gradient-to-br ${benefit.color} rounded-2xl flex items-center justify-center text-2xl text-white shadow-lg floating-animation`}>
                    <img src={benefit.icon} alt="" />
                  </div>
                </div>
                
                {/* Content */}
                <div className="relative z-10 inline-block  justify-center">
                  <p className=" text-xl flex justify-center font-bold text-[#F18372] mb-4 group-hover:text-[#F18372] transition-colors">
                    {benefit.title}
                  </p>
                  <p className="text-white flex justify-center leading-relaxed group-hover:text-[#ffddd8] transition-colors">
                    {benefit.description}
                  </p>
                </div>
