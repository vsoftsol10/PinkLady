  ...
  const storyChapters = [
    {
      ...
      year: "2013",
      content: "It was 2013 when everything seemed to fall apart. Our founder found herself battling PCOD and thyroid issues that turned her monthly cycles into a nightmare. The pain was unbearable, the discomfort constant, and the solutions available felt inadequate and expensive.",
      image: "🌧️",
    ...
    },
    {
      ...
      year: "Hope Returns",
      content: "What happened next felt like magic. The herbal blend worked wonders where modern solutions had failed. The pain subsided, the discomfort faded, and for the first time in years, she felt like herself again. But this wasn't just personal relief - it was a revelation.",
      image: "✨",
    ...
    },
    {
      ...
      year: "2014 & Beyond",
      content: "She realized she wasn't alone in her struggle. Countless women faced the same challenges - high costs, harmful chemicals, and solutions that didn't truly solve anything. What began as a personal remedy became a mission: to create something pure, affordable, and rooted in the wisdom of generations.",
      image: "🌸",
  ...
  return (
    <div className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 mb-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-10 right-4 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-tl from-rose-200/20 to-orange-200/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-block relative">
            ...
            <p className="text-base sm:text-lg text-gray-600 italic max-w-2xl mx-auto px-4">
              A journey from personal struggle to a mission of healing
            </p>
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <div className="relative h-80 sm:h-96 overflow-hidden rounded-2xl sm:rounded-3xl">
            {storyChapters.map((chapter, index) => (
              ...
              >
                <div className={`bg-gradient-to-br ${chapter.color} rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 h-full flex items-center relative overflow-hidden`}>
                  ...
                  <div className="text-white max-w-4xl pr-8 sm:pr-0">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold font-serif">{chapter.title}</h3>
                    </div>
        ...
        <div className="mb-12 sm:mb-16">
          <div className="bg-white/80 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-xl border border-white/60 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8 font-serif">What Pink Lady Is Today</h3>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
                <div className="space-y-4 sm:space-y-6">
                  <div className="bg-gradient-to-r from-rose-100 to-pink-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-left">
                    <h4 className="text-lg sm:text-xl font-semibold text-rose-800 mb-2 sm:mb-3">The Product</h4>
                    <p className="text-sm sm:text-base text-gray-700 font-serif">
                      Pink Lady (also known as <span className="font-bold text-rose-700">Paapatchi Herbal Napkin</span>) 
                      is more than just a sanitary napkin - it's a wellness experience infused with a special 
                      <span className="font-bold text-rose-700"> six-herbal blend</span> for natural comfort and protection.
                    </p>
                  </div>
                  <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-left">
                    <h4 className="text-lg sm:text-xl font-semibold text-amber-800 mb-2 sm:mb-3">The Philosophy</h4>
                    <p className="text-sm sm:text-base text-gray-700 font-serif">
                      We believe quality menstrual care shouldn't be a luxury. That's why Pink Lady is built as a 
                      <span className="font-bold text-amber-700"> service-driven initiative</span>, not a profit-hungry brand.
                    </p>
                  </div>
                </div>
                <div className="bg-gradient-to-br from-[#F18372] to-[#eb9f93] rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white">
                  <div className="text-center mb-4 sm:mb-6">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
                      <span className="text-2xl sm:text-3xl font-serif font-bold">6</span>
                    </div>
                    <h4 className="text-xl sm:text-2xl font-semibold mb-1 sm:mb-2">Powerful Herbs</h4>
                    <p className="text-sm sm:text-base text-white/90">Carefully selected natural ingredients</p>
                  </div>
        ...
        <div className="mb-12 sm:mb-16">
          <div className=" rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 font-serif">Our Promise to Every Woman</h3>
              <p className="text-base sm:text-lg md:text-xl leading-relaxed font-serif italic max-w-4xl mx-auto mb-6 sm:mb-8 text-gray-800 px-2 sm:px-0">
                "Today, Pink Lady Herbal Napkins are trusted by students, professionals, and women from all walks of life. 
                Our goal remains simple: to provide safe, sustainable, and affordable menstrual care while honoring 
                our roots in traditional healing."
              </p>
              <div className="inline-block bg-[#93b45d] rounded-full px-6 sm:px-8 py-2 sm:py-3">
                <span className="text-base sm:text-lg font-semibold">From our heart to your health</span>
              </div>
            </div>
          </div>
        </div>
